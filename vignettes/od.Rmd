...
## Example from od package vignette

This is a minimal example from the vigentte  of the package `od` (https://github.com/ITSLeeds/od/blob/master/vignettes/od.Rmd)
